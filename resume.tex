...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \begin{minipage}[t]{0.60\textwidth}
        ...
        \namesection{William}{Nunez}{Senior Data Engineer}

    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.35\textwidth}
        \git{\href{https://www.github.com/wllmnc}{wllmnc}}
        \linkedin{\href{https://www.linkedin.com/in/wllmnc}{wllmnc}}
        \email{\href{mailto:wnunez.mx@gmail.com}{wnunez.mx@gmail.com}}
        \phone{\href{tel:+523318922300}{3318922300}}
    \end{minipage}
    %{\contactline{\href{https://www.github.com/wllmnc}{wllmnc}}{\href{https://www.linkedin.com/in/wllmnc}{wllmnc}}{\href{mailto:wnunez.mx@gmail.com}{wnunez.mx@gmail.com}}{\href{tel:+523318922300}{3318922300}}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        \currentjobheader{EPAM}{Senior Data Enginer - Resource Manager}{Nov 2022}{Remote}
        ...
        \jobheader{Brightcove}{Staff Data Engineer}{Mar 2019 – Nov 2022}{Jalisco, Mexico}
        ...
        \jobheader{Ooyala}{Senior Data Engineer - Team Lead}{Sep 2017 – Mar 2019}{Jalisco, Mexico}
        ...
        \jobheader{Seagate}{Software Engineer}{Oct 2015 - Sep 2017}{Jalisco, Mexico}
        ...
        \jobheader{Intel}{Security Researcher Engineer}{Oct 2014 - Sept 2015}{Jalisco, Mexico}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        \skill{Jan 2021 - Present | SLC, Utah}
        School of Computing \\
        \skill{ Cum. GPA: 3.85 / 4.0 }

        \sectionsep
        \subsection{University of Oregon}
        \descript{Bachelor's in Computer Science
        \\and Engineering}
        \skill{May 2016 | Corvallis, OR}
        School of Computing \\
        \skill{ Cum. GPA: 3.7 / 4.0 }
        \sectionsep
